...
- [edoc-viewer](#edoc-viewer)
  ...
  * [API](#api)
    ...
    + [`initLocalization(array)`](#initlocalizationarray)
      - [Eksempel](#eksempel)
    ...
    + [Brukerhåndtering](#brukerhåndtering)
      ...
      - [Sjekke om bruker er pålogget, hente info om pålogget bruker](#sjekke-om-bruker-er-pålogget-hente-info-om-pålogget-bruker)
